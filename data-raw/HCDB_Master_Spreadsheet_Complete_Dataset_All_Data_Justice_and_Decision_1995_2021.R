...
justice_decision <- read_excel("~/Dropbox/High Court Project/Data Files/CURRENT DATASETS/HCDB Master Spreadsheet, Complete Dataset (All Data, Justice and Decision), 1995-2021.xlsx")


# save a copy of the excel file in data-raw
save(justice_decision, file="data-raw/HCDB Master Spreadsheet, Complete Dataset (All Data, Justice and Decision), 1995-2021.rda")
